...
public class MeleeAttack : EnemyAttack
{
    ...
    {
        if (Vector2.Distance(enemyTransform.position + enemyTransform.GetComponent<MeleeEnemyController>().enemyData.attackOffset, targetTransform.position) <= range) // Menzil kontrolü
        {
